...
import 'package:my_profile/widget/customBtn.dart';
...
import 'package:my_profile/widget/aboutMeMetaData.dart';
import 'package:my_profile/widget/communityIconBtn.dart';
import 'package:my_profile/widget/toolsTechWidget.dart';
        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              border: Border(
                bottom: BorderSide(
                    color: Colors.grey[900] ?? Colors.white, width: 1.0),
              ),
            ),
          ),
          SizedBox(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border(
                      bottom: BorderSide(
                          color: Colors.grey[900] ?? Colors.white, width: 2.0),
                    ),
                  ),
                ),
              ],
